...
The **Student Admission Form System** is a web-based application built using **Angular**. It helps schools 📚 collect, validate, and manage student admission form details digitally, reducing paperwork 📝 and improving efficiency ⚡.
...
- 🗄️ Database storage (MySQL / MongoDB / Firestore)
- 🧑‍💼 Admin dashboard for managing applications
- ✏️ Edit and delete admission forms
